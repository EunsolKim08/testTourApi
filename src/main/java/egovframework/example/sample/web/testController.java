...
public class testController {
	...
	@ResponseBody
	public String mapJsonParsing3() throws IOException {
		...
		try {
			//json = mapper.writeValueAsString(hmap);
			//nutrientDto = objectMapper.readValue(result, NutrientDTO.class);
			//System.out.println(nutrientDto);
			...
			System.out.println("페이지넘버 "+innerClassPersonDto.getBody().getPageNo());
			System.out.println("토탈넘버 "+innerClassPersonDto.getBody().getTotalCount());
			System.out.println("아이템리스트 "+innerClassPersonDto.getBody().getItems());
